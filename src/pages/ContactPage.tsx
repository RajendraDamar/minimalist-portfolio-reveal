      ...
      <div className="py-16 lg:py-24 px-6 lg:px-0 max-w-screen-xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-6 lg:pr-20">
            <h1 className="text-4xl md:text-5xl font-serif font-bold text-portfolio-charcoal mb-12 tracking-wide">RAJENDRA DAMAR</h1>
            
            <div className="space-y-8 text-portfolio-darkGray text-lg">
              <p>
              ...
              <div className="pt-8">
                <h3 className="text-xl font-medium text-portfolio-charcoal tracking-wide mb-4">CONTACT</h3>
                <p className="mb-2">hello@rajendradamar.com</p>
                <p className="mb-8">+62 812 3456 7890</p>
          ...
          {/* Right column - Image */}
          <div className="lg:col-span-6 h-[400px] md:h-[600px] lg:h-[80vh]">
            <img 
