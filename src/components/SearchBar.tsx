        ...
        {!isActive ? (
          ...
          <>
            ...
            <input
              ...
              className="pl-10 pr-10 py-2 w-full bg-portfolio-lightGray/30 rounded-full text-sm text-portfolio-white focus:outline-none border border-transparent focus:border-portfolio-gray/30 transition-all duration-200"
              autoComplete="off"
            />
          </>
        )}
